...
\end{figure}
 ...
 Wykorzystanie WebThing API umożliwi w przyszłości łatwą integrację sterownika z dodatkowymi urządzeniami.
 Możliwe do wykorzystania są na przykład:
 \begin{enumerate}
 \item[•] integracja z czujnikiem pogodowym
 \item[•] integracja z systemem odzyskiwania ciepła ze spalin
 \item[•] współpraca z innymi źródłami ciepła
 \end{enumerate}
...
% Testy jednostkowe zostały wykonane z wykorzystaniem Platformio Unit Testing \cite{PIOUnitTesting}. Pozwala na wykonywanie testów na urządzeniu docelowym lub z użyciem platformy Native, wtedy testy są przeprowadzane tylko w środowisku programistycznym.
 ...
 Aby poprawić dostępność i wygodę stworzonego rozwiązania, dla osób nie znających języka angielskiego, postanowiono dokonać tłumaczenia interfejsu Bramy WebThings na język polski. Projekt Bramy WebThings umożliwia dodawanie tłumaczeń z wykorzystaniem systemu Fluent \cite{fluent2020} który zapewnia naturalne brzmienie przekładów. Przygotowane tłumaczenie zostało dodane do projektu Bramy WebThings jako pull request. Zostało zatwierdzone i będzie dostępne po opublikowaniu najnowszej wersji Bramy WebThings.
