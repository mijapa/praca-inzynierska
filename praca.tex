...
\caption{Liczba firm oferujących rozwiązania IoT na poszczególnych rynkach. Zródło: \cite{gov2019}}
\label{fig:firmy}
\end{figure}
...
\caption{Ilość przesłanych fragmentów kodu przez społecznośc WebThings Gateway. Zródło: \cite{gatewaycommits2020}}
\label{fig:firmy}
\end{figure}
