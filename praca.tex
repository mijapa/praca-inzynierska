...
platformio init --ide clion --board esp32doit-devkit-v1 
 ...
 W niniejszym rozdziale opisałem dalszą część tworzenia oprogramowania sterownika, skupiając się na doskonaleniu i rozbudowie poszczególnych modułów oprogramowania o nowe funkcje i udogodnienia dla potencjalnego użytkownika.
  ...
  W portalu przechwytującym zaprog funkcję, wywoływaną w pętli głównej, podejmującą próbę połączenia z zapamiętaną siecią WiFi w przypadku utraty łączności.
 ...
 \section{Rozbudowa obsługi termopary MAX6675}
...
% Refleksja na temat tego jak wygląda to co zaplanowałem w stosunku do tego co udało się uzyskać.
 Z góry narzucony termin wykonania zawsze pozostawia pewien niedosyt co do zrealizowanej pracy.
 Brak możliwości informowania o zdarzeniach bezpośrednio przez sterownik. Możliwe tylko poprzez reguły Bramy.
 Brak minimalizacji otwarcia przepustnicy w przypadku zaniku napięcia.
 Jednak sterownik spełnia swoje podstawowe zadanie czyli pozwala na bezobsługową prace paleniska pomiędzy momentami dokładania paliwa, a wykorzystanie serwera WebThings pozwala na korzystanie z Bramy WebThings Mozilli oraz łatwą interakcję sterownika z innymi urządzeniami lub usługami online.
